...
import com.zhongbenshuo.air.interfaces.IMsgWebSocket;
...
public class WebSocketService extends Service {
    ...
    public void initWebSocket() {
        try {
            msgWebSocketClient = new WebSocketClient("ws://" + NetWork.SERVER_HOST_MAIN + ":" + NetWork.PORT_WEBSOCKET + "/" + NetWork.NAME_WEBSOCKET, new IMsgWebSocket() {
                @Override
