...
public class RegexUtils {  //------------------常量定义
    ...
    /**
     * URL正则表达式
     * 匹配 https http www ftp
     */
    // ^([hH][tT]{2}[pP]://|[hH][tT]{2}[pP][sS]://)(([A-Za-z0-9-~]+).)++([A-Za-z0-9-~\/])+$
    private static final String URL = "([hH][tT]{2}[pP]://|[hH][tT]{2}[pP][sS]://|[wW]{3}.|[wW][aA][pP].|[fF][tT][pP].|[fF][iI][lL][eE].)[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]";
...
////------------------验证方法
    ...
    /**
     * 匹配无http开头的网址，可能会出现Android WebView无法打开网址的情况，可以采取自动添加http://的形式
     *
     * @param url 原始URL
     * @return 添加了http://的URL
     */
